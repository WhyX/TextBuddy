...
public class TextBuddyTest {
	...
	public void testDeleteText() {
		...
		String expected2 = "deleted from testFile: \"earth and moon\"";
	...
	public void testDisplayTextList() {
		String[] test = {"display"};
		String expected1 = "testFile is empty";
		String expected2or3 = "all items in testFile displayed successfully";
		...
		tester.proceedUserAction(new String[] {"add", "32", "and", "74"});
		tester.proceedUserAction(new String[] {"add", "I", "am", "fine.", "Don't", "worry."});
		assertEquals("deleting item is not successful", expected2or3, tester.proceedUserAction(test));
	...
	public void testClearTextList() {
		String[] test = {"clear"};
		String expected1 = "testFile is empty";
		String expected2 = "all content deleted from testFile";
		String expected3 = "all content deleted from testFile";
